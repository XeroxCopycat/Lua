...
function init_gear_sets()
    ...
    --  /RDM --15, Fast Cast +71~73
		...
		head={ name="Merlinic Hood", augments={'Mag. Acc.+21 "Mag.Atk.Bns."+21','"Drain" and "Aspir" potency +4','MND+4','Mag. Acc.+13','"Mag.Atk.Bns."+8',}}, --8
		body={ name="Merlinic Jubbah", augments={'"Mag.Atk.Bns."+29','"Fast Cast"+5','MND+7','Mag. Acc.+14',}}, --11
		...
		back={ name="Lifestream Cape", augments={'Geomancy Skill +9','Indi. eff. dur. +15','Damage taken-1%',}}, --7
        }
